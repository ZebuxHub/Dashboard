getgenv().Configuration = {
    ...
    AutoPlace = true,
    AutoHatch = true,
    AutoUpgrade = true,   -- ใช้กับ conveyor upgrade
    AutoClaim = true,
    AutoDeploy = true,    -- วางตัวที่ดีกว่าแทนตัวช้า (ระบบ parabolic)
    AutoClaimDelaySeconds = 1,
    ...
    AutoBuyFruit = true,
    DesiredFruits = { "Apple","Strawberry","GoldMango", "Banana", "Corn", "Pineapple", "Grape", "Pear", "Watermelon", "Blueberry", "Orange" },
    -- กำหนดผลไม้ป้อนราย big pet slot (1,2,3)
    FeedSlots = {
        [1] = "Apple",
        [2] = "GoldMango",
        [3] = "Banana",
	...
	-- Discord webhook inventory snapshot
	WebhookEnabled = true,
	WebhookUrl = "https://discord.com/api/webhooks/1306438248528351283/ad0Cb4j7tMBWZRTskouA2vwzdKsC1W6B6GNA_EnO-_ztVj_QrrakVFqsgdCU45-QPYYB",
	WebhookInventoryEverySeconds = 60,

    -- ตั้ง buffer เงินขั้นต่ำที่ต้องเหลือก่อนซื้อ/ปลดล็อก (ถ้าอยากใช้)
    MoneyReserve = 0,

    -- Mutation priority (buy eggs showing these mutations first)
    MutationPriority = { "Golden", "Diamond", "Jurassic", "Fire", "Electirc","Snow" },
    RequireMutation = true,

	-- Which eggs to place and which mutations to allow (empty = any)
	PlaceEggTypes = {},
	PlaceMutations = { "Golden", "Diamond", "Jurassic", "Fire", "Electirc","Snow" },
	PlaceRequireMutation = true,

    AutoSell = true,
    SellPetSpeedBelow = 500,
    SellPetMutations = {"None"},
    SellEggMutations = {"None"},              -- delete pets without a mutation
